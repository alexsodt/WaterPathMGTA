...
extern "C" void c_printATOM( char *toFile_in, int bead, int res, struct atom_rec *atrec );

void c_printATOM( char *toFile_in, int bead, int res, struct atom_rec *atrec )
{
	printATOM( toFile_in, bead, res, atrec );
}
